      ...
      <div style={{
        ...
        <div style={{ padding: '10px 14px 0' }}>
          <label htmlFor="herb-search-input" style={{ display: 'flex', alignItems: 'center', gap: 8, backgroundColor: 'rgba(255,254,249,0.15)', borderRadius: 14, padding: '11px 14px', border: '1.5px solid rgba(255,254,249,0.25)', cursor: 'text' }}
            ...
            {!loading && !search ? (
              <button onClick={() => { setHerbView('list') }} style={{ padding: '5px 14px', backgroundColor: '#FFFEF9', color: '#1a3A2C', border: 'none', borderRadius: '20px', fontSize: '12px', fontWeight: 700, cursor: 'pointer', flexShrink: 0 }}>搜尋</button>
            ) : null}
          </label>
        </div>
